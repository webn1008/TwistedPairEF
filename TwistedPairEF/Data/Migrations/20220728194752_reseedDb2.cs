...
{
    public partial class reseedDb2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstBinderColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondBinderColor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "PairsModel",
                columns: new[] { "Id", "FirstBinderColor", "FirstColor", "PairNumber", "SecondBinderColor", "SecondColor" },
                values: new object[] { 2, null, "white", 2, null, "orange" });
